...
CREATE INDEX idx_assessments_triage ON assessments(triage_category);
CREATE INDEX idx_assessments_fit ON assessments(fit_score);
...
CREATE INDEX idx_assets_job ON application_assets(job_id);
...
CREATE INDEX idx_salary_role ON salary_data(role_category);
CREATE INDEX idx_salary_geo ON salary_data(geography);
